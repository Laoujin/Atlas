---
title: "High-signal long-form bloggers and newsletter authors for AI and software, 2026"
date: 2026-04-28
depth: deep
format: md
topic: "Long-form bloggers & newsletter authors"
topic_raw: "Long-form bloggers & newsletter authors"
issue: 41
tags: [ai, software, newsletters, blogs, reading-list, 2026]
...
- **swyx + Alessio Fanelli** — [Latent Space](https://www.latent.space/) — the AI Engineer newsletter+podcast and AINews aggregator [[42]][[24]]
- **Phillip Carter** — [Honeycomb](https://www.honeycomb.io/blog/llms-demand-observability-driven-development) — observability-driven development for LLMs; O'Reilly book on observability for LLMs [[46]]
- **Hugo Bowne-Anderson** — [Vanishing Gradients](https://hugobowne.substack.com/) — agents, evals, multimodal, data infra for builders [[49]]
- **Dan Becker** — [Mastering LLMs course with Hamel Husain](https://maven.com/parlance-labs/fine-tuning) — 40+ hours organized around evals, RAG, fine-tuning, prompts [[50]]
...
- **Casey Newton** — [Platformer](https://www.platformer.news/) — tone has visibly hardened toward urgency since 2024 ("Why I'm having trouble covering AI") [[57]][[58]]
- **Jack Clark** — [Import AI](https://jack-clark.net/) + Anthropic Institute (launched Mar 2026) [[66]]
- **Helen Toner** — [CSET, Georgetown](https://cset.georgetown.edu/staff/helen-toner/) — interim Executive Director at CSET; go-to voice on China, evals, AI governance [[67]]

### Macro / economist

- **Tyler Cowen** — [Marginal Revolution](https://marginalrevolution.com/marginalrevolution/2026/03/marginal-revolution-rise-and-decline-and-the-pending-ai-revolution.html) — frequent short posts plus a 40,000-word AI-augmented book in March 2026 ("Rise and Decline, and the Pending AI Revolution") [[61]][[62]]
- **Noah Smith** — [Noahpinion](https://www.noahpinion.blog/p/superintelligence-is-already-here) — openly flipped on AI risk in 2026 ("Superintelligence is already here", updated bioweapons concerns) [[63]][[64]]

### Specialist lenses

- **Matt Levine** — [Money Stuff](https://www.bloomberg.com/opinion/authors/ARbTQlRLRjE/matthew-s-levine) (free, Bloomberg) — the financial-AI lens: AI-debt, data-center financing, capital flows around AI [[65]]
- **Patrick McKenzie** — [Bits About Money](https://www.bitsaboutmoney.com/) + Complex Systems podcast — fintech-AI plumbing and the engineering economics of AI adoption [[68]]
- **Dwarkesh Patel** — [Dwarkesh essays](https://www.dwarkesh.com/t/essays) — pushing harder into written essays in 2026, with a [blog prize](https://www.dwarkesh.com/p/blog-prize) for big AI questions [[59]][[60]]
- **Thomas Ptacek** — Fly.io — "[My AI Skeptic Friends Are All Nuts](https://fly.io/blog/youre-all-nuts/)" marked his public flip; continues writing on agents and security [[70]]
- **Matt Rickard** — [blog.matt-rickard.com](https://blog.matt-rickard.com/) — daily short-form strategy posts ("The Spec Layer", "The Model is Not The Product") [[69]]
- **Karen Hao** — [karendhao.com](https://karendhao.com/) — leading critical-journalism voice on OpenAI labor, water/power footprint, and AGI as marketing narrative; author of *Empire of AI* [[71]]
