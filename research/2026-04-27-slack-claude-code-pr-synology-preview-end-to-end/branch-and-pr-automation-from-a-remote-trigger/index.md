...
| Schedule (`cron`) | Periodic scans (dependency bumps, dead-link sweeps) | Default branch | n/a | Renovate's primary mode [[11]](https://github.com/renovatebot/renovate) ⭐ 21k |
...
| Webhook from non-GitHub source (Linear, Sentry) | Custom logic | Probot app [[9]](https://github.com/probot/probot) ⭐ 9.5k + `octokit-plugin-create-pull-request` [[18]](https://github.com/gr2m/octokit-plugin-create-pull-request) ⭐ 114 |
