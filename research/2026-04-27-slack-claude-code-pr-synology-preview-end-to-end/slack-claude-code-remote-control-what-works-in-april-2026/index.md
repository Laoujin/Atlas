...
| **Replit Agent** | Replit Workspace (browser/IDE) | Replit cloud | IDE-side | Replit plan [[67]](https://replit.com/products/agent) | ⚠ Slack is a *data source*, not a trigger surface |
