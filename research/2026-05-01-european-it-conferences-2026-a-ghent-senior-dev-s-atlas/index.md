---
layout: expedition
title: "European IT conferences 2026 — a Ghent senior dev's atlas"
date: 2026-05-01
topic: "Build a categorized list of IT conferences in Europe relevant in 2026 to a senior developer/software engineer based in Ghent, Belgium with interests across software engineering, AI, software architecture, and C#/.NET, prioritizing those reachable by short flight or train; for each conference capture name, host city/country, 2026 (or next-edition) dates, primary tracks/topics, ticket price band in EUR, CFP status (open/closed/upcoming) with submission deadline and link, and a one-line fit note. Include closed CFPs too — closed ones are fine too, i can then apply next year — so the user can plan for the following cycle. Cover the major circuit (Devoxx family, GOTO, NDC family, KubeCon EU, QCon, JFokus, FOSDEM, Build Stuff, Voxxed Days), AI-applied tracks (World Summit AI, AI Engineer EU/Paris, Applied ML Days, MLConf EU equivalents), architecture-focused events (Software Architecture Gathering, DDD Europe, O'Reilly SACON EU if running), and the .NET-specific scene (Update Conference Prague, NDC Oslo/London/Copenhagen, dotnetdays, Techorama BE/NL, .NET Conf community editions). Note community/code-of-conduct red flags only when widely reported. Output as comparison tables grouped by track with CFP deadlines surfaced for quick scanning."
format: md
tags: [conferences, europe, 2026, software-engineering, developer-events]
summary: "A senior dev's 2026 calendar of European IT conferences across general SE, AI, architecture and .NET — picks, prices, and how to choose."
cover: cover.svg
synthesis: true
children:
  - slug: general-software-engineering-conferences-in-europe
...
**Two months bear the load: June and October.** June stacks NDC Copenhagen Jun 1-4 [[5]](https://ndccopenhagen.com/), DevSum Stockholm Jun 1-3 [[6]](https://www.devsum.se/), Craft Budapest Jun 4-5 [[7]](https://craft-conf.com/2026), DDD Europe Jun 8-12 [[2]](https://2026.dddeurope.com/), AI Summit London Jun 10-11 [[8]](https://london.theaisummit.com/), and ICSA Amsterdam Jun 22-26 [[9]](https://conf.researchr.org/home/icsa-2026) — six flagships, four overlapping pairs. October overlaps Devoxx Belgium with JAX London (both Oct 5-9) [[3]](https://devoxx.be/)[[10]](https://jaxlondon.com/), then runs ai-PULSE Paris Oct 13 [[11]](https://www.ai-pulse.eu/), .NET DeveloperDays Warsaw Oct 19-23 [[12]](https://developerdays.eu/warsaw/), Code BEAM Haarlem Oct 21-22 [[13]](https://codebeameurope.com/), and Techorama Netherlands Oct 26-28 [[14]](https://www.techorama.nl/) on consecutive weeks. Pick at most one per cluster.

**The AI/architecture/SE separation is collapsing on the program side.** Devoxx Belgium runs an explicit Architecture track on multi-agent systems, A2A and MCP [[3]](https://devoxx.be/); KubeCon EU 2026's keynotes were AI-infra dominated [[15]](https://www.cncf.io/blog/2025/08/05/kubecon-cloudnativecon-europe-2026-returning-to-amsterdam-23-26-march/); QCon London's 20th-anniversary edition leaned into agentic AI and platform ROI [[16]](https://www.infoq.com/news/2026/02/qcon-previews-20th-anniversary/). The implication: a generalist event with a strong AI track (Devoxx, GOTO Copenhagen [[17]](https://gotocph.com/2026), NDC Oslo [[18]](https://ndcoslo.com/)) can substitute for a dedicated AI conference unless you need depth on a specific subspecialty — which is where ML Prague (May 4-6) [[19]](https://www.mlprague.com/) or Applied AI Berlin (May 28) [[20]](https://conference.techeurope.io/) earn their slot.

**The original brief asked for CFP deadlines surfaced; the children only partially delivered.** The Devoxx Belgium CFP runs Jun 1 - Jul 17, 2026 [[3]](https://devoxx.be/) — the one window cited explicitly. iSAQB Software Architecture Forum Munich's very-early-bird closed Apr 2 [[21]](https://conferences.isaqb.org/software-architecture-forum/); NDC Oslo all-access early bird ends May 22 [[22]](https://ndcoslo.com/tickets); GOTO Copenhagen's early bird closed May 1 [[17]](https://gotocph.com/2026). Other CFPs aren't surfaced in the source pages — for autumn-2026 and 2027 events with windows still open, dev.events' architecture and .NET feeds are the recommended discovery channels [[23]](https://dev.events/EU/architecture)[[24]](https://dev.events/EU/dotnet).
